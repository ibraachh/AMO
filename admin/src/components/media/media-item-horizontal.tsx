...
export function MediaItemHorizontal({ post }: Props) {
  ...
  const { title, coverUrl, createdAt, totalViews, totalShares, description } = post;
      ...
      >
        <MenuList>
          <MenuItem
            onClick={() => {
              popover.onClose();
              router.push(paths.dashboard.mediaCenter.edit(title));
            }}
          >
