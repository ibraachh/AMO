...
import AmoTradeLogo from "../../assets/image/amo-do-logo.svg";
  ...
  const getList = async () => {
    try {
      ...
      const res = await useFetch(
        endpoints.company.getAllByName + "amodo",
        headers
      );
      setCompanyData(res);
      setLoading(false);
    ...
    <section className="relative z-[999]" id="amotrade">
      {loading ? (
        ...
        <div className="container max-sm:!p-0 max-w-[70%] min-h-[70vh] mx-auto flex justify-start flex-col">
          ...
          <div className="w-full flex items-start justify-center flex-col gap-4 text-center my-16">
            <img
              loading="lazy"
